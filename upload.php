        ...
        <div class="row">
            <div class="col-md-12"> <br>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" name="poster_name" required class="form-control" placeholder="รายละเอียด"> <br>
...
if (isset($_POST['poster_name'])) {
    ...
    if ($upload != '') {
        ...
        if ($typefile == '.jpg' || $typefile  == '.jpeg' || $typefile  == '.png') {
            ...
            //sql insert
            $stmt = $conn->prepare("INSERT INTO poster (poster_name, img_file)
    VALUES (:poster_name, '$newname')");
